 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function YE(t){sn(new $t("platform-logger",e=>new lE(e),"PRIVATE")),sn(new $t("heartbeat",e=>new qE(e),"PRIVATE")),xt(qo,Jc,t),xt(qo,Jc,"esm2017"),xt("fire-js","")}YE("");const nu="@firebase/database",su="0.13.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hC{constructor(e,n,s){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=s,this.auth_=null,this.auth_=s.getImmediate({optional:!0}),this.auth_||s.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(Ve("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,s)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,s):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',st(e)}}class Qo{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}Qo.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $d{constructor(e){this.allowedEvents_=e,this.listeners_={},T(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const s=[...this.listeners_[e]];for(let i=0;i<s.length;i++)s[i].callback.apply(s[i].context,n)}}on(e,n,s){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:s});const i=this.getInitialEvent(e);i&&n.apply(s,i)}off(e,n,s){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let r=0;r<i.length;r++)if(i[r].callback===n&&(!s||s===i[r].context)){i.splice(r,1);return}}validateEventType_(e){T(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ui extends $d{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!sd()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Ui}getInitialEvent(e){return T(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Za extends $d{constructor(){super(["visible"]);let e,n;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(n="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(n="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(n="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(n="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,n&&document.addEventListener(n,()=>{const s=!document[e];s!==this.visible_&&(this.visible_=s,this.trigger("visible",s))},!1)}static getInstance(){return new Za}getInitialEvent(e){return T(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nw=!0;function He(t,e=null){if(t===null)return H.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),T(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new Me(n,He(e))}if(!(t instanceof Array)&&nw){const n=[];let s=!1;if(Je(t,(o,a)=>{if(o.substring(0,1)!=="."){const l=He(a);l.isEmpty()||(s=s||!l.getPriority().isEmpty(),n.push(new Z(o,l)))}}),n.length===0)return H.EMPTY_NODE;const r=zi(n,GC,o=>o.name,el);if(s){const o=zi(n,Ae.getCompare());return new H(r,He(e),new Mt({".priority":o},{".priority":Ae}))}else return new H(r,He(e),Mt.Default)}else{let n=H.EMPTY_NODE;return Je(t,(s,i)=>{if(Vt(t,s)&&s.substring(0,1)!=="."){const r=He(i);(r.isLeafNode()||!r.isEmpty())&&(n=n.updateImmediateChild(s,r))}}),n.updatePriority(He(e))}}QC(He);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iw extends Tr{compare(e,n){const s=e.node.compareTo(n.node);return s===0?ms(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return Z.MIN}maxPost(){return Z.MAX}makePost(e,n){const s=He(e);return new Z(n,s)}toString(){return".value"}}const rw=new iw;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ki(){return{value:null,children:new Map}}function Yd(t,e,n){if(te(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=ee(e);t.children.has(s)||t.children.set(s,Ki());const i=t.children.get(s);e=be(e),Yd(i,e,n)}}function Zo(t,e,n){t.value!==null?n(e,t.value):uw(t,(s,i)=>{const r=new me(e.toString()+"/"+s);Zo(i,r,n)})}function uw(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gi{constructor(e,n,s){this.path=e,this.affectedTree=n,this.revert=s,this.type=gt.ACK_USER_WRITE,this.source=Qd()}operationForChild(e){if(te(this.path)){if(this.affectedTree.value!=null)return T(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new me(e));return new Gi(oe(),n,this.revert)}}else return T(ee(this.path)===e,"operationForChild called for unrelated child."),new Gi(be(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Js{constructor(e,n){this.source=e,this.path=n,this.type=gt.LISTEN_COMPLETE}operationForChild(e){return te(this.path)?new Js(this.source,oe()):new Js(this.source,be(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class On{constructor(e,n,s){this.source=e,this.path=n,this.snap=s,this.type=gt.OVERWRITE}operationForChild(e){return te(this.path)?new On(this.source,oe(),this.snap.getImmediateChild(e)):new On(this.source,be(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zs{constructor(e,n,s){this.source=e,this.path=n,this.children=s,this.type=gt.MERGE}operationForChild(e){if(te(this.path)){const n=this.children.subtree(new me(e));return n.isEmpty()?null:n.value?new On(this.source,oe(),n.value):new Zs(this.source,oe(),n)}else return T(ee(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Zs(this.source,be(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt{constructor(e){this.writeTree_=e}static empty(){return new bt(new we(null))}}function Ds(t,e,n){if(te(e))return new bt(new we(n));{const s=t.writeTree_.findRootMostValueAndPath(e);if(s!=null){const i=s.path;let r=s.value;const o=Qe(i,e);return r=r.updateChild(o,n),new bt(t.writeTree_.set(i,r))}else{const i=new we(n),r=t.writeTree_.setTree(e,i);return new bt(r)}}}function Eu(t,e,n){let s=t;return Je(n,(i,r)=>{s=Ds(s,ke(e,i),r)}),s}function Cu(t,e){if(te(e))return bt.empty();{const n=t.writeTree_.setTree(e,new we(null));return new bt(n)}}function ta(t,e){return Ln(t,e)!=null}function Ln(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(Qe(n.path,e)):null}function wu(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(Ae,(s,i)=>{e.push(new Z(s,i))}):t.writeTree_.children.inorderTraversal((s,i)=>{i.value!=null&&e.push(new Z(s,i.value))}),e}function en(t,e){if(te(e))return t;{const n=Ln(t,e);return n!=null?new bt(new we(n)):new bt(t.writeTree_.subtree(e))}}function na(t){return t.writeTree_.isEmpty()}function us(t,e){return Jd(oe(),t.writeTree_,e)}function Jd(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let s=null;return e.children.inorderTraversal((i,r)=>{i===".priority"?(T(r.value!==null,"Priority writes must always be leaf nodes"),s=r.value):n=Jd(ke(t,i),r,n)}),!n.getChild(t).isEmpty()&&s!==null&&(n=n.updateChild(ke(t,".priority"),s)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dw(t){return{filter:t}}function Fw(t,e){T(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),T(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function Lw(t,e,n,s,i){const r=new kw;let o,a;if(n.type===gt.OVERWRITE){const c=n;c.source.fromUser?o=sa(t,e,c.path,c.snap,s,i,r):(T(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!te(c.path),o=Xi(t,e,c.path,c.snap,s,i,a,r))}else if(n.type===gt.MERGE){const c=n;c.source.fromUser?o=Bw(t,e,c.path,c.children,s,i,r):(T(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=ia(t,e,c.path,c.children,s,i,a,r))}else if(n.type===gt.ACK_USER_WRITE){const c=n;c.revert?o=Hw(t,e,c.path,s,i,r):o=jw(t,e,c.path,c.affectedTree,s,i,r)}else if(n.type===gt.LISTEN_COMPLETE)o=Vw(t,e,n.path,s,r);else throw ps("Unknown operation type: "+n.type);const l=r.getChanges();return $w(e,o,l),{viewCache:o,changes:l}}function $w(t,e,n){const s=e.eventCache;if(s.isFullyInitialized()){const i=s.getNode().isLeafNode()||s.getNode().isEmpty(),r=ea(t);(n.length>0||!t.eventCache.isFullyInitialized()||i&&!s.getNode().equals(r)||!s.getNode().getPriority().equals(r.getPriority()))&&n.push(Gd(ea(e)))}}function ip(t,e,n,s,i,r){const o=e.eventCache;if(Qi(s,n)!=null)return e;{let a,l;if(te(n))if(T(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=kn(e),u=c instanceof H?c:H.EMPTY_NODE,f=ol(s,u);a=t.filter.updateFullNode(e.eventCache.getNode(),f,r)}else{const c=Yi(s,kn(e));a=t.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=ee(n);if(c===".priority"){T(rn(n)===1,"Can't have a priority with additional path components");const u=o.getNode();l=e.serverCache.getNode();const f=Iu(s,n,u,l);f!=null?a=t.filter.updatePriority(u,f):a=o.getNode()}else{const u=be(n);let f;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const h=Iu(s,n,o.getNode(),l);h!=null?f=o.getNode().getImmediateChild(c).updateChild(u,h):f=o.getNode().getImmediateChild(c)}else f=al(s,c,e.serverCache);f!=null?a=t.filter.updateChild(o.getNode(),c,f,u,i,r):a=o.getNode()}}return Ms(e,a,o.isFullyInitialized()||te(n),t.filter.filtersNodes())}}function Xi(t,e,n,s,i,r,o,a){const l=e.serverCache;let c;const u=o?t.filter:t.filter.getIndexedFilter();if(te(n))c=u.updateFullNode(l.getNode(),s,null);else if(u.filtersNodes()&&!l.isFiltered()){const p=l.getNode().updateChild(n,s);c=u.updateFullNode(l.getNode(),p,null)}else{const p=ee(n);if(!l.isCompleteForPath(n)&&rn(n)>1)return e;const _=be(n),b=l.getNode().getImmediateChild(p).updateChild(_,s);p===".priority"?c=u.updatePriority(l.getNode(),b):c=u.updateChild(l.getNode(),p,b,_,sp,null)}const f=Xd(e,c,l.isFullyInitialized()||te(n),u.filtersNodes()),h=new ll(i,f,r);return ip(t,f,n,i,h,a)}function sa(t,e,n,s,i,r,o){const a=e.eventCache;let l,c;const u=new ll(i,e,r);if(te(n))c=t.filter.updateFullNode(e.eventCache.getNode(),s,o),l=Ms(e,c,!0,t.filter.filtersNodes());else{const f=ee(n);if(f===".priority")c=t.filter.updatePriority(e.eventCache.getNode(),s),l=Ms(e,c,a.isFullyInitialized(),a.isFiltered());else{const h=be(n),p=a.getNode().getImmediateChild(f);let _;if(te(h))_=s;else{const y=u.getCompleteChild(f);y!=null?Bd(h)===".priority"&&y.getChild(Vd(h)).isEmpty()?_=y:_=y.updateChild(h,s):_=H.EMPTY_NODE}if(p.equals(_))l=e;else{const y=t.filter.updateChild(a.getNode(),f,_,h,u,o);l=Ms(e,y,a.isFullyInitialized(),t.filter.filtersNodes())}}}return l}function Tu(t,e){return t.eventCache.isCompleteForChild(e)}function Bw(t,e,n,s,i,r,o){let a=e;return s.foreach((l,c)=>{const u=ke(n,l);Tu(e,ee(u))&&(a=sa(t,a,u,c,i,r,o))}),s.foreach((l,c)=>{const u=ke(n,l);Tu(e,ee(u))||(a=sa(t,a,u,c,i,r,o))}),a}function Su(t,e,n){return n.foreach((s,i)=>{e=e.updateChild(s,i)}),e}function ia(t,e,n,s,i,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;te(n)?c=s:c=new we(null).setTree(n,s);const u=e.serverCache.getNode();return c.children.inorderTraversal((f,h)=>{if(u.hasChild(f)){const p=e.serverCache.getNode().getImmediateChild(f),_=Su(t,p,h);l=Xi(t,l,new me(f),_,i,r,o,a)}}),c.children.inorderTraversal((f,h)=>{const p=!e.serverCache.isCompleteForChild(f)&&h.value===null;if(!u.hasChild(f)&&!p){const _=e.serverCache.getNode().getImmediateChild(f),y=Su(t,_,h);l=Xi(t,l,new me(f),y,i,r,o,a)}}),l}function jw(t,e,n,s,i,r,o){if(Qi(i,n)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(s.value!=null){if(te(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return Xi(t,e,n,l.getNode().getChild(n),i,r,a,o);if(te(n)){let c=new we(null);return l.getNode().forEachChild(Jn,(u,f)=>{c=c.set(new me(u),f)}),ia(t,e,n,c,i,r,a,o)}else return e}else{let c=new we(null);return s.foreach((u,f)=>{const h=ke(n,u);l.isCompleteForPath(h)&&(c=c.set(u,l.getNode().getChild(h)))}),ia(t,e,n,c,i,r,a,o)}}function Vw(t,e,n,s,i){const r=e.serverCache,o=Xd(e,r.getNode(),r.isFullyInitialized()||te(n),r.isFiltered());return ip(t,o,n,s,sp,i)}function Hw(t,e,n,s,i,r){let o;if(Qi(s,n)!=null)return e;{const a=new ll(s,e,i),l=e.eventCache.getNode();let c;if(te(n)||ee(n)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Yi(s,kn(e));else{const f=e.serverCache.getNode();T(f instanceof H,"serverChildren would be complete if leaf node"),u=ol(s,f)}u=u,c=t.filter.updateFullNode(l,u,r)}else{const u=ee(n);let f=al(s,u,e.serverCache);f==null&&e.serverCache.isCompleteForChild(u)&&(f=l.getImmediateChild(u)),f!=null?c=t.filter.updateChild(l,u,f,be(n),a,r):e.eventCache.getNode().hasChild(u)?c=t.filter.updateChild(l,u,H.EMPTY_NODE,be(n),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Yi(s,kn(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||Qi(s,oe())!=null,Ms(e,c,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nT(t){QE(BE),sn(new $t("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return XI(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),xt(nu,su,t),xt(nu,su,"esm2017")}Ft.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Ft.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};nT();const Op="@firebase/installations",Il="0.5.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fp({projectId:t}){return`${sT}/projects/${t}/installations`}function Lp(t){return{token:t.token,requestStatus:2,expiresIn:cT(t.expiresIn),creationTime:Date.now()}}async function $p(t,e){const s=(await e.json()).error;return Mn.create("request-failed",{requestName:t,serverCode:s.code,serverMessage:s.message,serverStatus:s.status})}function Bp({apiKey:t}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function lT(t,{refreshToken:e}){const n=Bp(t);return n.append("Authorization",uT(e)),n}async function jp(t){const e=await t();return e.status>=500&&e.status<600?t():e}function cT(t){return Number(t.replace("s","000"))}function uT(t){return`${Mp} ${t}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fT({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const s=Fp(t),i=Bp(t),r=e.getImmediate({optional:!0});if(r){const c=await r.getHeartbeatsHeader();c&&i.append("x-firebase-client",c)}const o={fid:n,authVersion:Mp,appId:t.appId,sdkVersion:kp},a={method:"POST",headers:i,body:JSON.stringify(o)},l=await jp(()=>fetch(s,a));if(l.ok){const c=await l.json();return{fid:c.fid||n,registrationStatus:2,refreshToken:c.refreshToken,authToken:Lp(c.authToken)}}else throw await $p("Create Installation",l)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gp="installations",$T="installations-internal",BT=t=>{const e=t.getProvider("app").getImmediate(),n=LT(e),s=li(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},jT=t=>{const e=t.getProvider("app").getImmediate(),n=li(e,Gp).getImmediate();return{getId:()=>MT(n),getToken:i=>DT(n,i)}};function VT(){sn(new $t(Gp,BT,"PUBLIC")),sn(new $t($T,jT,"PRIVATE"))}VT();xt(Op,Il);xt(Op,Il,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hS{constructor(e){this.app=e}_delete(){return delete Ls[this.app.options.appId],Promise.resolve()}}let Ls={},Bu=[];const ju={};let fo="dataLayer",dS="gtag",Vu,Zp,Hu=!1;function pS(){const t=[];if(A0()&&t.push("This is a browser extension environment."),O0()||t.push("Cookies are not available."),t.length>0){const e=t.map((s,i)=>`(${i+1}) ${s}`).join(" "),n=ut.create("invalid-analytics-context",{errorInfo:e});it.warn(n.message)}}function mS(t,e,n){pS();const s=t.options.appId;if(!s)throw ut.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)it.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw ut.create("no-api-key");if(Ls[s]!=null)throw ut.create("already-exists",{id:s});if(!Hu){KT(fo);const{wrappedGtag:r,gtagCore:o}=XT(Ls,Bu,ju,fo,dS);Zp=r,Vu=o,Hu=!0}return Ls[s]=fS(t,Bu,ju,e,Vu,fo,n),new hS(t)}function em(t=dd()){t=ai(t);const e=li(t,sr);return e.isInitialized()?e.getImmediate():_S(t)}function _S(t,e={}){const n=li(t,sr);if(n.isInitialized()){const i=n.getImmediate();if(Vi(e,n.getOptions()))return i;throw ut.create("already-initialized")}return n.initialize({options:e})}function ca(t,e,n,s){t=ai(t),cS(Zp,Ls[t.app.options.appId],e,n,s).catch(i=>it.error(i))}const Wu="@firebase/analytics",Uu="0.8.0";function gS(){sn(new $t(sr,(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return mS(s,i,n)},"PUBLIC")),sn(new $t("analytics-internal",t,"PRIVATE")),xt(Wu,Uu),xt(Wu,Uu,"esm2017");function t(e){try{const n=e.getProvider(sr).getImmediate();return{logEvent:(s,i,r)=>ca(n,s,i,r)}}catch(n){throw ut.create("interop-component-reg-failed",{reason:n})}}}gS();const tm=Lg("projects",()=>{const t=Be([]),e=Be({}),n=Be({}),s=tT(),i=em(),r=qI(s,"projects/");GI(r,c=>{e.value=c.val(),t.value=Object.values(e.value).sort((u,f)=>u.order-f.order)});function o(c){n.value=c}function a(c){ca(i,`navbar_click: ${c}`)}function l(){ca(i,"page_view")}return{data:t,analyticsNavbarClicked:a,analyticsPageView:l,setSelected:o,selectedProject:n}}),yS={class:"fixed w-full flex flex-row bg-zinc-50 z-50"},vS={class:"mx-auto lg:ml-auto flex flex-row gap-10 text-zinc-500 p-5"},bS=["enter","onClick"],ES=At({__name:"Nav",setup(t){const e=tm();function n(i){e.analyticsNavbarClicked(i),window.location.href=i}const s=[{label:"Home",link:"#blurb"},{label:"About",link:"#aboutMe"},{label:"My Projects",link:"#projects"}];return(i,r)=>{const o=ni("motion");return Ie(),Re("div",yS,[X("div",vS,[(Ie(),Re(Ge,null,mr(s,(a,l)=>dt(X("a",{key:l,initial:{opacity:0},enter:{opacity:1,transition:{duration:300,delay:200*l,type:"keyframes",ease:"easeInOut"}},onClick:c=>n(a.link),class:"hover:text-zinc-600 cursor-pointer transition-all duration-200"},[Ze(es(a.label),1)],8,bS),[[o]])),64))])])}}}),CS=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n},wS={},IS={class:"bg-zinc-900 flex justify-center gap-10"},TS=X("a",{href:"https://www.digitalocean.com/?refcode=d198439c69e7&utm_campaign=Referral_Invite&utm_medium=Referral_Program&utm_source=badge"},[X("img",{src:"https://web-platforms.sfo2.digitaloceanspaces.com/WWW/Badge%203.svg",alt:"DigitalOcean Referral Badge",class:"w-32 h-32"})],-1),SS=X("div",{class:"text-zinc-50 my-auto"}," Made by Rewel Cabiles ",-1),xS=[TS,SS];function RS(t,e){return Ie(),Re("div",IS,xS)}const AS=CS(wS,[["render",RS]]),NS=["enter"],OS=["href","title"],PS=At({__name:"iconList",setup(t){const e=[{type:"img",link:"https://github.com/rewelcabiles",icon:"fa-brands fa-github ",title:"Github"},{type:"img",link:"https://www.linkedin.com/in/rewel-cabiles/",icon:"fa-brands fa-linkedin",title:"Linkedin"},{type:"img",link:"https://assets.rewelcabiles.me/portfolio/resume.pdf",icon:"fa-solid fa-file",title:"Resume"},{type:"img",link:"mailto:rewel.cabiles@gmail.com",icon:"fa-solid fa-envelope text-zinc-50 text-xl hover:scale-125 text-zinc-800 transition-all duration-50",title:"Email"}];return(n,s)=>{const i=ni("motion");return dt((Ie(),Re("div",{initial:{x:-2400},enter:{x:0,transition:{duration:2e3,delay:1200,type:"spring",mass:.3}},class:"flex flex-row gap-4 rounded-md py-2 px-3 align-middle my-auto"},[(Ie(),Re(Ge,null,mr(e,(r,o)=>X("a",{href:r.link,key:o,target:"_blank",title:r.title,class:"align-center"},[X("i",{class:ti(`${r.icon} text-xl hover:scale-125 text-zinc-800 transition-all duration-50`)},null,2)],8,OS)),64))],8,NS)),[[i]])}}}),kS={class:"w-screen h-screen"},MS={class:"px-auto py-44",initial:{opacity:0},enter:{opacity:1,transition:{duration:1e3,delay:400,type:"keyframes",ease:"easeInOut"}}},DS={class:"w-full mx-auto mb-12"},FS=["enter"],LS=X("div",{class:"md:text-5xl text-2xl text-zinc-900 text-center"}," Hi! I'm Rewel Cabiles ",-1),$S=X("div",{class:"md:ml-5 mt-6 text-lg text-zinc-900 lg:px-0 px-10 pb-10 text-center"}," I\u2019m a software & web developer based in Hong Kong / Philippines ",-1),BS=At({__name:"Slide1",setup(t){return(e,n)=>{const s=ni("motion");return Ie(),Re("div",kS,[dt((Ie(),Re("div",MS,[X("div",DS,[dt(X("img",{initial:{y:-2400},enter:{y:0,transition:{duration:3e3,delay:1300,type:"spring",mass:.2}},src:"https://assets.rewelcabiles.me/portfolio/me.jpeg",class:"rounded-full border-4 shadow-xl mx-auto w-32 h-32"},null,8,FS),[[s]]),Oe(PS,{id:"linkSmalls",class:"mt-4 mx-auto w-fit"})]),LS,$S])),[[s]])])}}}),jS={class:"font-bold text-lg from-zinc-900 to-zinc-800 bg-gradient-to-tr text-white p-4 border-b-2"},VS=At({__name:"SlideProjectCards",props:{data:{type:Object,default:{}},selected:{type:Boolean,default:!1}},setup(t){const e=Be(["md:h-40","lg:w-64","w-full","md:32","hover:border-4","border-zinc-900","aspect-video","transition-all","duration-50","rounded-md","bg-cover","bg-center","cursor-pointer","shadow-md"]);return(n,s)=>(Ie(),Re("div",{class:ti(e.value.concat(t.selected?["lg:scale-125 scale-105 z-50 border-4"]:["scale-100","z-20"])),style:ir(`background-image: url(${t.data.preview})`),onClick:s[0]||(s[0]=i=>n.$emit("projectCardClicked",t.data))},[X("div",jS,es(t.data.name),1)],6))}}),HS={class:"w-screen min-h-screen py-40 gap-y-20 flex flex-col"},WS={class:"flex flex-col gap-2 lg:px-40"},US=["enter"],zS=Ze(" My personal Projects "),qS=[zS],KS=X("div",{class:"mx-auto font-light"}," Click on a card for more information. ",-1),GS={class:"flex xl:flex-row flex-col z-50 lg:px-40"},YS={initial:{opacity:0},visible:{opacity:1,transition:{duration:250,delay:100}},class:"flex flex-wrap flex-row content-start gap-10 px-10 lg:px-0 py-10 lg:py-0 z-50 xl:w-2/3 w-full"},QS={id:"projectDetails",class:"py-16 px-10 xl:w-1/3 pb-20"},XS={key:0,class:"text-zinc-800 flex flex-col gap-4"},JS={class:"text-3xl font-bold"},ZS={id:"icons",class:"flex flex-row gap-5"},ex={key:0,class:"align-center"},tx=["href"],nx=X("i",{class:"fa-brands fa-github mr-1"},null,-1),sx=Ze("Github "),ix=[nx,sx],rx={key:1,class:"align-center"},ox=["href"],ax=X("i",{class:"fa-sharp fa-solid fa-house mr-1"},null,-1),lx=Ze("Homepage "),cx=[ax,lx],ux={id:"info_desc",class:"text-justify"},fx=At({__name:"SlideProjects",setup(t){const e=tm();function n(s){e.setSelected(s),setTimeout(()=>{var i=document.getElementById("projectDetails");i.scrollIntoView({behavior:"smooth"})},100)}return(s,i)=>{const r=ni("motion");return Ie(),Re("div",HS,[X("div",WS,[dt((Ie(),Re("div",{initial:{y:-100,opacity:0},enter:{y:0,opacity:1,transition:{duration:250,delay:100,type:"spring",mass:.2}},class:"md:text-4xl text-3xl font-bold text-zinc-900 mx-auto"},qS,8,US)),[[r]]),KS]),X("div",GS,[dt((Ie(),Re("div",YS,[(Ie(!0),Re(Ge,null,mr(xe(e).data,(o,a)=>(Ie(),xa(VS,{key:a,data:o,selected:o.name===xe(e).selectedProject,onProjectCardClicked:l=>n(o)},null,8,["data","selected","onProjectCardClicked"]))),128))])),[[r]]),X("div",QS,[Oe(Na,{"enter-active-class":"duration-500 ease-out","enter-from-class":"transform opacity-0","enter-to-class":"opacity-100"},{default:If(()=>[xe(e).selectedProject?(Ie(),Re("div",XS,[X("div",JS,es(xe(e).selectedProject.name),1),X("div",ZS,[xe(e).selectedProject.github?(Ie(),Re("div",ex,[X("a",{href:xe(e).selectedProject.github,target:"_blank"},ix,8,tx)])):Br("",!0),xe(e).selectedProject.homepage?(Ie(),Re("div",rx,[X("a",{href:"https://"+xe(e).selectedProject.homepage,target:"_blank"},cx,8,ox)])):Br("",!0)]),X("div",ux,es(xe(e).selectedProject.description),1)])):Br("",!0)]),_:1})])])])}}}),hx={class:"min-h-screen from-zinc-900 to-zinc-800 bg-gradient-to-tr pt-40 z-50"},dx={class:"py-10 flex flex-col lg:px-20 px-5"},px={class:"flex xl:flex-row flex-col mx-auto gap-10 xl:gap-44 xl:px-20"},mx={class:"text-zinc-50 md:px-10 w-full"},_x={initial:{opacity:0},visible:{opacity:1,transition:{duration:500,delay:50}},class:"mx-auto text-4xl z-50 mb-10"},gx=Ze(" About me "),yx=[gx],vx={initial:{opacity:0},visible:{opacity:1,transition:{duration:500,delay:200}},class:"z-50 text-justify"},bx=Ze(" I'm Rewel, I was born in the Philippines, raised in Hong Kong, then moved back to the Philippines around High school. I've always been interested in programming, picking up Python as my first programming language at around the age of 14 and then just exploring what the this hobby had to offer; "),Ex=X("br",null,null,-1),Cx=Ze(),wx=X("br",null,null,-1),Ix=Ze(" Making games, building websites, tinkering with servers, eventually even working on microcontrollers like the Raspberry PI, Arduino, and so far my favourite, the various ESP boards "),Tx=X("br",null,null,-1),Sx=Ze(),xx=X("br",null,null,-1),Rx=Ze(" I studied Computer Science at Adamson University, Philippines, not hesitating on my course, and I spent most of my free time continuing to work on programming not just as a hobby but academically now too. "),Ax=X("br",null,null,-1),Nx=Ze(),Ox=X("br",null,null,-1),Px=[bx,Ex,Cx,wx,Ix,Tx,Sx,xx,Rx,Ax,Nx,Ox],kx={class:"text-zinc-50 w-full md:px-10"},Mx={initial:{opacity:0},visible:{opacity:1,transition:{duration:500,delay:500}},class:"mx-auto text-4xl z-50 mb-10"},Dx=Ze(" My Experience "),Fx=[Dx],Lx={initial:{opacity:0},visible:{opacity:1,transition:{duration:500,delay:600}},class:"z-50 pb-4"},$x=Ze(" I've had the pleasure of working and learning at these great places "),Bx=[$x],jx={class:"flex flex-col gap-5"},Vx=["visible"],Hx=["href","target"],Wx={class:"flex flex-row text-zinc-50 mb-1 text-lg font-bold"},Ux={class:"text-justify text-zinc-50 text-md leading-tight"},zx=At({__name:"about",setup(t){const e=[{name:"Payruler",link:"https://payruler.com/",description:"I was here as an Intern, working as a backend web developer in the R&D department. I built APIs for the projects we worked on there, occasionally helping with infrustructure related tasks like fixing or setting up servers hosted either on-site or in Azure. I learned how to collaborate in a team environment and shared my ideas on how we could improve some of the projects there."},{name:"Raykan",position:"Front end developer",link:"https://raykan.co/",description:"This is a startup company im working with to help build websites and systems for clients. I'm currently working here as a front end developer, using my favourite web framework Vue."}];return(n,s)=>{const i=ni("motion");return Ie(),Re("div",hx,[X("div",dx,[X("div",px,[X("div",mx,[dt((Ie(),Re("div",_x,yx)),[[i]]),dt((Ie(),Re("div",vx,Px)),[[i]])]),X("div",kx,[dt((Ie(),Re("div",Mx,Fx)),[[i]]),dt((Ie(),Re("div",Lx,Bx)),[[i]]),X("div",jx,[(Ie(),Re(Ge,null,mr(e,(r,o)=>dt(X("div",{initial:{opacity:0},visible:{opacity:1,transition:{duration:200,delay:100*(o+1)}},key:o,class:"bg-zinc-900 rounded-sm p-5"},[X("a",{href:r.link,target:r.link=="#"?"":"_blank"},[X("div",Wx,es(r.name),1),X("div",Ux,es(r.description),1)],8,Hx)],8,Vx),[[i]])),64))])])])])])}}}),qx={id:"frontpage",class:"h-screen w-screen scroll-smooth bg-slate-50 overflow-x-hidden"},Kx=At({__name:"FrontPage",setup(t){return(e,n)=>(Ie(),Re("div",qx,[Oe(ES,{class:"z-10"}),Oe(BS,{id:"blurb",class:"z-0 snap-center"}),Oe(zx,{id:"aboutMe",class:"snap-center z-50"}),Oe(fx,{id:"projects"}),Oe(AS)]))}});const Gx=C0({history:Bb("/"),routes:[{path:"/",name:"home",component:Kx}]});var Yx="firebase",Qx="9.9.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
